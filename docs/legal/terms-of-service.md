...
Our service is currently intended for users in Nigeria only.
...
We may update these terms from time to time. The revised version will apply once published.

## Contact

For terms questions, email `feastyfooders@gmail.com`.
